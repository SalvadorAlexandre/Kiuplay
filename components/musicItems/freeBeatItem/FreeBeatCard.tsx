...
interface FreeBeatCardProps {
    item: FreeBeat;
    onPress: (exclusivebeat: FreeBeat) => void;
}

export default function ExclusiveBeatCard({ item, onPress }: FreeBeatCardProps) {
    ...
    return (
        <View style={styles.mainContentWrapper}>
            ...
            <View style={styles.musicDetails}>
                ...
                <Text style={styles.cardCategoryText}></Text>
                <Text style={styles.cardPriceText}>{item.typeUse}</Text>
            </View>
        </View>
    );
}
