// components/cardsItems/AlbumCard.tsx
...
export default function AlbumCard({ item, onPress }: AlbumCardProps) {
 ...
 */
const CardContent = ({ item, coverSource }: { item: Album, coverSource: any }) => (
