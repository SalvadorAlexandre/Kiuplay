// components/cardsItems/EpCard.tsx
...
interface ExtendedPlayEPCardProps {
  item: ExtendedPlayEP;
  onPress: (item: ExtendedPlayEP) => void;
}

export default function EpCard({ item, onPress }: ExtendedPlayEPCardProps) {
 ...
 */
const CardContent = ({ item, coverSource }: { item: ExtendedPlayEP, coverSource: any }) => (
  <View style={styles.mainContentWrapper}>
    ...
    <View style={styles.musicDetails}>
      ...
      <View style={styles.infoRow}>
        ...
        {item.releaseYear && item.mainGenre && <Text style={styles.dotSeparator}> • </Text>}
        {item.mainGenre && <Text style={styles.cardDetailText} numberOfLines={1}>{item.mainGenre}</Text>}
      </View>
