        ...
        <Modal visible={visible} transparent animationType="fade">
            <View style={styles.overlay}>
                <View style={styles.container}>
                    ...
                    {type === 'confirm' && <Ionicons name="help-circle" size={60} color="#FFD700" />}
...
const styles = StyleSheet.create({
    ...
    progressText: { color: '#FFD700', marginTop: 10, fontWeight: 'bold' },
    ...
    btnClose: { backgroundColor: '#FFD700', paddingVertical: 10, paddingHorizontal: 30, borderRadius: 10 },
