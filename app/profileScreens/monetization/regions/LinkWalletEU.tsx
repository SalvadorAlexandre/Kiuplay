    ...
    <>
      ...
      >
        ...
        <View style={styles.termsBox}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', }}>
            <Image source={require('@/assets/images/payments/Mollie.png')} style={{
              tintColor: '#fff',
              width: 150,
              height: 100,
              resizeMode: 'contain',
          ...
          <Text style={styles.countryText}>
            Detectamos que esta região está elegível para uso de duas moedas baseadas nas provedoras Mollie (Moeda locaL-EUR para transações direitas)
