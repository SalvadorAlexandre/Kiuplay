                        ...
                        <>
                            ...
                            {epData.createdAt && (
                                <Text style={styles.pendingText}>
                                    {t('postEP.pendingSince')}: {formatDate(epData.createdAt)}
                                </Text>
                            )}
                            ...
                            <View style={styles.actionButtonsRow}>
                                ...
                                >
                                    ...
                                    <Text style={styles.btnAbortTextSmall}> {t('postEP.delete')}</Text>
                                </TouchableOpacity>
